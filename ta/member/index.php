...
<?php 
            ...
            if(empty($_GET)){
              ...
              }elseif($_GET['page']=='tersedia'){
                include 'content/tersedia.php';
              }elseif($_GET['page']=='map'){
                include 'content/map.php';
              }elseif($_GET['page']=='cetak'){
                include 'content/cetak.php';
              }elseif($_GET['page']=='edituser'){
                include 'content/edituser.php';
              }elseif($_GET['page']=='detailitem'){
                include 'content/detailitem.php';
              }elseif($_GET['page']=='cari'){
                include 'content/daftarpencarian.php';
              }
          }
