...
if($tanggalPilih <= $tanggalSekarang){
    echo "<script>alert('Tanggal Tidak Bisa di Pilih/ Anda Belum Memilih Tanggal')</script>";
            ...
            <div class="modal-body request-model-body ">
              <form id="form_boking" action="cetak.php?direct=true" method="post">
                  ...
                  <div class="form-group row">
                    ...
                    <input class="hidden" type="date" class="form-control" placeholder="" id="l_name" name="tgl" value="<?=$tanggalPilih?>" readonly/></div> 
                  <!-- </div> -->
